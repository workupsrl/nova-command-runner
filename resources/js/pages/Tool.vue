<template>
    <div class="command-runner">
        ...
        <Card class="flex flex-col items-center">
            <div class="flex w-full pt-2 pb-6 px-2">
                <div
                    v-for="(group, index) in groups"
                    class="flex-1 text-grey-darker text-center bg-grey-light px-4 py-2 m-2"
                    :key="index"
                >
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            return Nova.request()
                .get('/nova-vendor/workup/nova-command-runner')
                .then((response) => {
                    this.groups = [];
        ...
        runCommand() {
            ...
            Nova.request()
                .post('/nova-vendor/workup/nova-command-runner/run', {
